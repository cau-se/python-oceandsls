...
autogenerated_comments: Set = {"! <<Replace with return expression here>>", "! <<Replace with SUBROUTINE body here>>"}


def filter_xml(xml_path: str = "", need_public: bool = False, modules: List[ModuleSymbol] = [
], files: Dict[str, Tuple[float, str, str]] = {}) -> Tuple[List[Tuple[str]], List[Tuple[str, str, List[str]]]]:
    """
