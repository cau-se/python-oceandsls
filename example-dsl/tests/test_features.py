...
from lsprotocol.types import (DidCloseTextDocumentParams, DidOpenTextDocumentParams, TextDocumentIdentifier, TextDocumentItem)
...
# try:
#     from ..exampleLSPServer.server import completions, did_close, did_open
